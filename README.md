...
- 챗봇이 해당 질문에 대해 얼마나 정확하게 답했는지를 기준으로 GPT를 활용하여 자동으로 채점
...
> 챗봇은 대부분의 주요 질문에 대해 정확하고 실무적인 응답을 제공했으며, 실제 자용자가 접할 가능성이 높은 항목에서는 강한 퍼포먼스를 보였다. 다만, 최신 개정 반영 여부와 예외조건 설명력은 지속적인 보완이 필요하다.
